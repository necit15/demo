	...
	<body>
        ...
        <script>
            ...
            DG.then(function () {
              ...
              DG.marker([55.7721, 49.1948]).addTo(map).bindPopup('"Биосфера" <br> ул. Родины, 7 <br> Тел. +7 (843) 290-27-73');
              DG.marker([55.8391, 49.0431]).addTo(map).bindPopup('"Партнер-Сити" <br> ул. Васильченко, 8 <br> Тел. +7 (843) 512-15-93');
            });
        </script> 
                    </div>
